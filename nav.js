...
(function () {
  ...
  var CSS = ""
    ...
    + "background:rgba(9,26,17,0.94);backdrop-filter:blur(8px);-webkit-backdrop-filter:blur(8px);"
    ...
    + "nav.site-nav .site-nav-dropdown-menu a.active{color:#F2B705;font-weight:600;}"
